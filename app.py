...
def call(number, name, clinic_name):
    ...
    payload = {
        "assistant": {
            ...
            "firstMessage": f"Olá {name}, fala a Ava da {clinic_name}. Estou a ligar para relembrar que tem uma consulta agendada para amanha às duas da tarde, confirma que vai estar presente?",
